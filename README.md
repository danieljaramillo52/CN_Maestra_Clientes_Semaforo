...
![Descargar_Zip_Repostorio](docs/Img/image.png)

2. Descomprimir el proyecto **Plano_Rent-main.zip**

![Descomprimir_Zip_proyecto](docs/Img/image-1.png)

![Descomprimir_Zip_proyecto2](docs/Img/image-2.png)

3. Descomprimir el archivo **python-3.12.5-embed.zip** en el directorio actual. 

![Descomprimir_Zip_entorno1](docs/Img/image-3.png)

Previo a extraer **eliminamos el nombre de la carpeta** que vamos a descomprimir de la ruta. 

![Descomprimir_Zip_entorno2](docs/Img/image-4.png)

![Descomprimir_Zip_entorno3](docs/Img/image-5.png)
...
![Entorno descomprimido ](docs/Img/image-6.png)
